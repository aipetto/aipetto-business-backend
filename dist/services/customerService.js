...
class CustomerService {
    ...
    create(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                mongooseRepository_1.default.handleUniqueFieldError(error, this.options.language, 'customer');
                throw error;
            }
        });
    }
    ...
    destroyAll(ids) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                for (const id of ids) {
                    yield customerRepository_1.default.destroy(id, Object.assign(Object.assign({}, this.options), { session }));
                }
                yield mongooseRepository_1.default.commitTransaction(session);
            }
            catch (error) {
    ...
    findById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return customerRepository_1.default.findById(id, this.options);
        });
    }
    findAllAutocomplete(search, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            return customerRepository_1.default.findAllAutocomplete(search, limit, this.options);
        });
    }
    findAndCountAll(args) {
        return __awaiter(this, void 0, void 0, function* () {
            return customerRepository_1.default.findAndCountAll(args, this.options);
        });
    }
    ...
    _isImportHashExistent(importHash) {
        return __awaiter(this, void 0, void 0, function* () {
            const count = yield customerRepository_1.default.count({
                importHash,
            }, this.options);
            return count > 0;
        });
