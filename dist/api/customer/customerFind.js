...
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        new permissionChecker_1.default(req).validateHas(permissions_1.default.values.customerRead);
        const payload = yield new customerService_1.default(req).findById(req.params.id);
...
//# sourceMappingURL=customerFind.js.map