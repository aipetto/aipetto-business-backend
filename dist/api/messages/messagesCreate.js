...
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        new permissionChecker_1.default(req).validateHas(permissions_1.default.values.messagesCreate);
        const payload = yield new messagesService_1.default(req).create(req.body.data);
...
//# sourceMappingURL=messagesCreate.js.map