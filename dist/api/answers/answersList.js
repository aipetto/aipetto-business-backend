...
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        new permissionChecker_1.default(req).validateHas(permissions_1.default.values.answersRead);
        const payload = yield new answersService_1.default(req).findAndCountAll(req.query);
...
//# sourceMappingURL=answersList.js.map