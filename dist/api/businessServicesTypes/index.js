...
exports.default = (app) => {
    ...
    app.get(`/tenant/:tenantId/business-services-types/autocomplete`, require('./businessServicesTypesAutocomplete').default);
    app.get(`/tenant/:tenantId/business-services-types`, require('./businessServicesTypesList').default);
    app.get(`/tenant/:tenantId/business-services-types/:id`, require('./businessServicesTypesFind').default);
};
