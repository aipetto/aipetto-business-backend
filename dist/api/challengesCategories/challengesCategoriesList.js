...
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        new permissionChecker_1.default(req).validateHas(permissions_1.default.values.challengesCategoriesRead);
        const payload = yield new challengesCategoriesService_1.default(req).findAndCountAll(req.query);
...
//# sourceMappingURL=challengesCategoriesList.js.map