...
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        new permissionChecker_1.default(req).validateHas(permissions_1.default.values.stateRead);
        const payload = yield new stateService_1.default(req).findById(req.params.id);
...
//# sourceMappingURL=stateFind.js.map