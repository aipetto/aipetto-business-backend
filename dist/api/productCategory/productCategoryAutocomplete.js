...
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const payload = yield new productCategoryService_1.default(req).findAllAutocomplete(req.query.query, req.query.limit);
...
//# sourceMappingURL=productCategoryAutocomplete.js.map