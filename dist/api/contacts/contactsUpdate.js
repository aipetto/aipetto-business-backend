...
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        new permissionChecker_1.default(req).validateHas(permissions_1.default.values.contactsEdit);
        const payload = yield new contactsService_1.default(req).update(req.params.id, req.body.data);
