...
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        new permissionChecker_1.default(req).validateHas(permissions_1.default.values.contactsCreate);
        const payload = yield new contactsService_1.default(req).create(req.body.data);
...
//# sourceMappingURL=contactsCreate.js.map