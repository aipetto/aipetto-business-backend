...
class BusinessPlaceServiceAvailabilityRepository {
    static create(data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [record] = yield businessPlaceServiceAvailability_1.default(options.database).create([
    ...
    static update(id, data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const currentTenant = mongooseRepository_1.default.getCurrentTenant(options);
            let record = yield mongooseRepository_1.default.wrapWithSessionIfExists(businessPlaceServiceAvailability_1.default(options.database).findOne({ _id: id, tenant: currentTenant.id }), options);
            if (!record) {
                throw new Error404_1.default();
            }
            yield businessPlaceServiceAvailability_1.default(options.database).updateOne({ _id: id }, Object.assign(Object.assign({}, data), { updatedBy: mongooseRepository_1.default.getCurrentUser(options).id }), options);
    ...
    static destroy(id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield businessPlaceServiceAvailability_1.default(options.database).deleteOne({ _id: id }, options);
    ...
    static filterIdsInTenant(ids, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const currentTenant = mongooseRepository_1.default.getCurrentTenant(options);
            const records = yield businessPlaceServiceAvailability_1.default(options.database)
                .find({
                _id: { $in: ids },
    ...
    static count(filter, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const currentTenant = mongooseRepository_1.default.getCurrentTenant(options);
            return mongooseRepository_1.default.wrapWithSessionIfExists(businessPlaceServiceAvailability_1.default(options.database).countDocuments(Object.assign(Object.assign({}, filter), { tenant: currentTenant.id })), options);
        });
    }
    static findById(id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const currentTenant = mongooseRepository_1.default.getCurrentTenant(options);
            let record = yield mongooseRepository_1.default.wrapWithSessionIfExists(businessPlaceServiceAvailability_1.default(options.database)
                .findOne({ _id: id, tenant: currentTenant.id })
                .populate('businessId')
                .populate('serviceType')
                .populate('places'), options);
            if (!record) {
                throw new Error404_1.default();
            }
    ...
    static findAndCountAll({ filter, limit = 0, offset = 0, orderBy = '' }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (filter) {
                ...
                if (filter.workOnHolidays === true ||
                    filter.workOnHolidays === 'true' ||
                    filter.workOnHolidays === false ||
                    filter.workOnHolidays === 'false') {
                    criteriaAnd.push({
                        workOnHolidays: filter.workOnHolidays === true ||
                            filter.workOnHolidays === 'true',
                    });
                }
            ...
            const criteria = criteriaAnd.length
                ? { $and: criteriaAnd }
                : null;
            let rows = yield businessPlaceServiceAvailability_1.default(options.database)
                .find(criteria)
                .skip(skip)
                .limit(limitEscaped)
                .sort(sort)
                ...
                .populate('serviceType')
                .populate('places');
            const count = yield businessPlaceServiceAvailability_1.default(options.database).countDocuments(criteria);
    ...
    static _createAuditLog(action, id, data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            yield auditLogRepository_1.default.log({
                entityName: businessPlaceServiceAvailability_1.default(options.database).modelName,
                entityId: id,
                action,
                values: data,
            }, options);
...
exports.default = BusinessPlaceServiceAvailabilityRepository;
//# sourceMappingURL=businessPlaceServiceAvailabilityRepository.js.map