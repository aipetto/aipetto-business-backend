...
class PointsChallengesRepository {
    static create(data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [record] = yield pointsChallenges_1.default(options.database).create([
    ...
    static update(id, data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const currentTenant = mongooseRepository_1.default.getCurrentTenant(options);
            let record = yield mongooseRepository_1.default.wrapWithSessionIfExists(pointsChallenges_1.default(options.database).findOne({ _id: id, tenant: currentTenant.id }), options);
            if (!record) {
                throw new Error404_1.default();
            }
            yield pointsChallenges_1.default(options.database).updateOne({ _id: id }, Object.assign(Object.assign({}, data), { updatedBy: mongooseRepository_1.default.getCurrentUser(options).id }), options);
    ...
    static destroy(id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield pointsChallenges_1.default(options.database).deleteOne({ _id: id }, options);
    ...
    static filterIdsInTenant(ids, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const currentTenant = mongooseRepository_1.default.getCurrentTenant(options);
            const records = yield pointsChallenges_1.default(options.database)
                .find({
                _id: { $in: ids },
    ...
    static count(filter, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const currentTenant = mongooseRepository_1.default.getCurrentTenant(options);
            return mongooseRepository_1.default.wrapWithSessionIfExists(pointsChallenges_1.default(options.database).countDocuments(Object.assign(Object.assign({}, filter), { tenant: currentTenant.id })), options);
        });
    }
    static findById(id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const currentTenant = mongooseRepository_1.default.getCurrentTenant(options);
            let record = yield mongooseRepository_1.default.wrapWithSessionIfExists(pointsChallenges_1.default(options.database)
    ...
    static findAndCountAll({ filter, limit = 0, offset = 0, orderBy = '' }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const criteria = criteriaAnd.length
                ? { $and: criteriaAnd }
                : null;
            let rows = yield pointsChallenges_1.default(options.database)
                .find(criteria)
                .skip(skip)
                .limit(limitEscaped)
                .sort(sort)
                .populate('country');
            const count = yield pointsChallenges_1.default(options.database).countDocuments(criteria);
    ...
    static _createAuditLog(action, id, data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            yield auditLogRepository_1.default.log({
                entityName: pointsChallenges_1.default(options.database).modelName,
                entityId: id,
                action,
                values: data,
            }, options);
...
exports.default = PointsChallengesRepository;
//# sourceMappingURL=pointsChallengesRepository.js.map