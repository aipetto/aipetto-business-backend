...
class ServiceReservationRepository {
    ...
    static count(filter, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const currentTenant = mongooseRepository_1.default.getCurrentTenant(options);
            return mongooseRepository_1.default.wrapWithSessionIfExists(serviceReservation_1.default(options.database).countDocuments(Object.assign(Object.assign({}, filter), { tenant: currentTenant.id })), options);
        });
    }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (filter) {
                ...
                if (filter.needTransportation === true ||
                    ...
                    filter.needTransportation === 'false') {
                    criteriaAnd.push({
                        needTransportation: filter.needTransportation === true ||
                            filter.needTransportation === 'true',
                    });
                }
                if (filter.place) {
                    criteriaAnd.push({
                        place: mongooseQueryUtils_1.default.uuid(filter.place),
                    });
                }
                if (filter.status) {
                    criteriaAnd.push({
            ...
            const criteria = criteriaAnd.length
                ? { $and: criteriaAnd }
                : null;
            let rows = yield serviceReservation_1.default(options.database)
                .find(criteria)
                .skip(skip)
                .limit(limitEscaped)
                .sort(sort)
    ...
    static _createAuditLog(action, id, data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            yield auditLogRepository_1.default.log({
                entityName: serviceReservation_1.default(options.database).modelName,
                entityId: id,
                action,
                values: data,
            }, options);
...
exports.default = ServiceReservationRepository;
//# sourceMappingURL=serviceReservationRepository.js.map