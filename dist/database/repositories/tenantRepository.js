...
class TenantRepository {
    ...
    static update(id, data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield mongooseRepository_1.default.wrapWithSessionIfExists(tenant_1.default(options.database).updateOne({ _id: id }, Object.assign(Object.assign({}, data), { updatedBy: mongooseRepository_1.default.getCurrentUser(options).id })), options);
    ...
    static updatePlanUser(id, planStripeCustomerId, planUserId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield mongooseRepository_1.default.wrapWithSessionIfExists(tenant_1.default(options.database).updateOne({ _id: id }, data), options);
            yield this._createAuditLog(auditLogRepository_1.default.UPDATE, id, data, options);
            return yield this.findById(id, options);
        });
    }
    static updatePlanStatus(planStripeCustomerId, plan, planStatus, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield mongooseRepository_1.default.wrapWithSessionIfExists(tenant_1.default(options.database).updateOne({ _id: record.id }, data), options);
    ...
    static destroy(id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield mongooseRepository_1.default.wrapWithSessionIfExists(tenant_1.default(options.database).deleteOne({ _id: id }), options);
            yield this._createAuditLog(auditLogRepository_1.default.DELETE, id, record, options);
            yield mongooseRepository_1.default.wrapWithSessionIfExists(customer_1.default(options.database).deleteMany({ tenant: id }), options);
            yield mongooseRepository_1.default.wrapWithSessionIfExists(product_1.default(options.database).deleteMany({ tenant: id }), options);
            yield mongooseRepository_1.default.wrapWithSessionIfExists(order_1.default(options.database).deleteMany({ tenant: id }), options);
            yield mongooseRepository_1.default.wrapWithSessionIfExists(pet_1.default(options.database).deleteMany({ tenant: id }), options);
            yield mongooseRepository_1.default.wrapWithSessionIfExists(breed_1.default(options.database).deleteMany({ tenant: id }), options);
            yield mongooseRepository_1.default.wrapWithSessionIfExists(petTypes_1.default(options.database).deleteMany({ tenant: id }), options);
            yield mongooseRepository_1.default.wrapWithSessionIfExists(business_1.default(options.database).deleteMany({ tenant: id }), options);
            yield mongooseRepository_1.default.wrapWithSessionIfExists(place_1.default(options.database).deleteMany({ tenant: id }), options);
            yield mongooseRepository_1.default.wrapWithSessionIfExists(businessServicesTypes_1.default(options.database).deleteMany({ tenant: id }), options);
            yield mongooseRepository_1.default.wrapWithSessionIfExists(serviceReservation_1.default(options.database).deleteMany({ tenant: id }), options);
            yield mongooseRepository_1.default.wrapWithSessionIfExists(settings_1.default(options.database).deleteMany({ tenant: id }), options);
            yield mongooseRepository_1.default.wrapWithSessionIfExists(user_1.default(options.database).updateMany({}, {
                $pull: {
                    tenants: { tenant: id },
                },
            }), options);
